    ...
    <div class="eu-softSkills">
      <div class="eu">
        ...
        <div>
          <p>
            <span>&lt;p&gt;</span>
            Sou uma desenvolvedora <span>FullStack</span> apaixonada por criar
                ...
                <div>
                  ...
                  <div>
                    ...
                    <box-icon
                      ...
                      color="#ffffff"
                    ></box-icon>
                    <box-icon size="lg" name="music" color="#ffffff"></box-icon>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="soft-skills">
        ...
        <div class="card-skills">
          ...
          <div>
            ...
            <p>
              a habilidade de identificar e resolver problemas técnicos e de
              negócios de forma eficaz.
            </p>
          </div>
        </div>
        <div class="card-skills">
          <box-icon size="5em" name="wink-tongue" color="#ffffff"></box-icon>
          <div>
            <h3>Criatividade</h3>
            <p>
              a habilidade de pensar fora da caixa para encontrar soluções
  ...
  <div class="div-sobre">
    ...
    <div>
      ...
      <p>
        ...
        soluções web incríveis e intuitivas para os usuários. Possuo conhecimento
